...
% take online tutorials on how to do web scraper in python. 
...
%% p skill on how to use PyTorch, running experiments on google colab GPUs
%% architecture of CNN.  
...
\ganttgroup{Journal article}{30}{35} \\
